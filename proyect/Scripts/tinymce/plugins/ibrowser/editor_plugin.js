...
// ================================================
Internal image object like a flash placeholder if (ed.dom.getAttrib(e, 'class').indexOf('mceItem') != -1) return; 
	...
	NJW MOD - Fix for FF3 Compatibility var ib = iBrowser_GetIb(); 